...
def remove_cart(request, product_id, cart_item_id):# pass in the request and product_id
    ...
    try:
        if request.user.is_authenticated:
            cart_item = CartItem.objects.get(product=product, user=request.user, id = cart_item_id)#bring us the cart item
        else:
            cart = Cart.objects.get(cart_id = _cart_id(request))
        cart_item = CartItem.objects.get(product=product, cart = cart, id = cart_item_id)#bring us the cart item
